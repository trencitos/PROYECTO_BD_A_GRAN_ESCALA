...
\subsection{1. Contratos de Esquema y Calidad}
...
\subsection{2. Orquestación del DAG}
...
\subsection{3. Matriz de Resiliencia y Procesamiento Paralelo}
Para la ingesta inicial, aunque Beam divide bloques nativamente, cumplimos el requerimiento técnico desarrollando una clase \texttt{ParallelCSVReaderFn}. Esta función utiliza colas (\texttt{Queue}) compartidas y levanta 4 hilos (\texttt{threading.Thread}) protegidos por un \texttt{threading.Lock()}, logrando parsear el archivo línea por línea en memoria de forma ultra eficiente.
...
\subsection{4. Sinking Strategy e Idempotencia}
...
\subsection{5. El Modelo de las 4 Preguntas de Beam}
\begin{itemize}
